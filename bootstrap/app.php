<?php
// require_once __DIR__ . '/../app/Api/Functions/utils.php';
...
// 后台管理系统接口路由文件
$app->group(['namespace' => 'App\Http\ManagerApi\Controllers'], function ($app) {
    require __DIR__ . '/../app/Http/ManagerApi/routes/route.php';
});
